...
<body>
    ...
    <h3>Danh sách phiếu thuê chi tiết</h3>
    <table class="table table-bordered">
        ...
        <?php for ($i = 0; $i < count($chitietphieuthues); $i++) { ?>
            <tr>
                <td><?= $i + 1 ?></td>
                <td><?= $phieuthues[$chitietphieuthues[$i]->phieuthueid] ?></td>
                <td><?= $sachs[$chitietphieuthues[$i]->sachid] ?></td>
            </tr>
        <?php } ?>
    </table>
    <!-- Optional JavaScript -->
